...
The scRNA‐seq and bulk RNA‐seq data are available on Gene Expression Omnibus (GES319710, GSE319215). The processed gene‐expression data, proteomic data, and code generated in this study are available on Zenodo (DOI: https://doi.org/10.5281/zenodo.18019630).
